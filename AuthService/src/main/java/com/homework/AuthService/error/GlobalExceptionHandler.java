...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(com.homework.AuthService.error.AuthException.class)
    public ResponseEntity<String> handleHttpMessageNotReadable(com.homework.AuthService.error.AuthException ex) {
